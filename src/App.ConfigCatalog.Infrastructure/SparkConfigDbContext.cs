...
namespace App.ConfigCatalog.Infrastructure;

/// <summary>
/// Minimal DbContext dedicated to the configuration catalog.
/// In App, you can merge these DbSets into your existing AppDbContext instead.
/// </summary>
public sealed class AppConfigDbContext : DbContext
{
